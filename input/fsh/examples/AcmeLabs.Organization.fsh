...
* extension[=].valueString = "HL7/ccda-on-fhir/source/resources/organization/organization-1.xml"
* identifier[0].system = "http://hl7.org.fhir/sid/us-npi"
* identifier[=].value = "1144221847"
* identifier[+].system = "http://www.acme.org/organization"
* identifier[=].value = "2523423456"
* active = true
* type = http://hl7.org/fhir/organization-type#prov "Healthcare Provider"
* name = "Acme Labs"
