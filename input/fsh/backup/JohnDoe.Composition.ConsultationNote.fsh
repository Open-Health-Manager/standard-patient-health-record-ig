...
Description: "John Doe - Composition - Consultation Note"
Usage: #example
* meta.versionId = "1"
* meta.lastUpdated = "2018-10-04T19:42:52.061-04:00"
* meta.profile = "http://hl7.org/fhir/us/ccda/StructureDefinition/CCDA-on-FHIR-Consultation-Note"
* language = #en-US
...
* encounter = Reference(Encounter/encounter-1) "Encounter with patient Amy V. Shaw"
...
* event.period.start = "2015-11-18"
* event.period.end = "2015-12-12"
* section[0].title = "Advance Directives Section"
...
* section[+].title = "Allergies and Intolerances Section"
...
* section[=].entry = Reference(http://hl7.org/fhir/StructureDefinition/FamilyMemberHistory)
...
* section[=].text.status = #generated
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><table><tr><td><b>Vital Sign</b></td><td><b>Date</b></td><td><b>Value</b></td></tr><tr><td>Temperature</td><td>2016/04/05</td><td>39 Degrees Celcius</td></tr></table></div>"
