...
As we apply this data model to patient needs, we want to broadly organize it to support personalized medicine, public health laws, and patient empowerment over their own health.  Doing so, we have specific inerests in defining both a physiology model (internal to the patient), a public health & social determinants model (external to the patient), and an administrative executive function model for decision making (things the patient has control over).  In considering models of Self/Other, we posit that a basic psychoanalytic model of Id/Ego/Super Ego satisified this design goals and serves as a useful organizing model.


![./IdEgoSuperEgo.jpg](./IdEgoSuperEgo.jpg){:width="100%"}

#### Physiology Resources (Id)
>>>>>>> 644a3fe06df60e99fce33e9a3fc77ce519817062
